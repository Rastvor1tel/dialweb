...
$APPLICATION->SetTitle(Loc::getMessage('PAGE_VIDEO_REVIEWS_META_PAGETITLE'));
$APPLICATION->SetPageProperty("subtitle", Loc::getMessage('PAGE_VIDEO_REVIEWS_META_SUBTITLE'));
...
$APPLICATION->IncludeComponent("bitrix:news.list", "video-reviews", Array(
