                ...
                <div class="container-inner">
                    <div class="banner__wrap-inner">
                        ...
                        <div class="banner__info">
                            <div class="banner__description">Стремимся к развитию вашего бизнеса в виде оборотов /
                                прибыли. Только правильные решения, подобранные под вашу задачу.
                            </div>
            ...
            <div class="services__wrap-outer">
                <div class="container-inner">
                    <div class="services__wrap-inner">
                        ...
                        <div class="services__slogan slogan">Мы используем передовые технологии и подходы, что
                            гарантирует их эффективность, качество и практичность
                        </div>
                        <?
                    ...
                    <div class="development__wrap-inner">
                        <div class="development__top">
                            <div class="development__info">
                                ...
                                <div class="development__description">Одно из основных направлений деятельности нашей
                                    компании. Это не просто разработка современного интернет-ресурса, а совместный
                                    творческий и аналитический процесс группы профессионалов и заказчика. Основная цель
                                    создания – максимальный рост целевых обращений с сайта.
                                </div>
                            ...
                            <div class="development__banner">
                                <div class="development__banner-description"><b>Долгосрочное сотрудничество —</b>
                                    ключевой показатель эффективности работы. Крупнейшие клиенты работают с нами <b>более
                                        5 лет.</b></div>
                            </div>
                        </div>
                        ...
                        <div class="academy__banner angle-white">
                            <div class="academy__info">
                                ...
                                <div class="academy__item">
                                    ...
                                    <div class="academy__description">Научись создавать сайты на платформе 1С Битрикс
                                    </div>
                                </div>
                                <div class="academy__item">
                                    <div class="academy__name">HTML5 + CSS3 + JS</div>
                                    <div class="academy__description">Освой технологии верстки и создай свой первый
                                        сайт!
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="contacts__wrap-inner">
                        <div class="contacts__left">
                            ...
                            <div class="contacts__menu">
                                ...
                                <a class="contacts__menu-link _popup" data-popup="js-popup-service"
                                   style="cursor: pointer;">Работать вместе</a>
                            </div>
                        </div>
                        <div class="contacts__center">
                            <div class="contacts__cities">
                                <button type="button"
                                        class="contacts__city<?= SITE_ID == 's1' || SITE_ID == 's4' ? ' _active' : ''; ?>">
                                    Тула
                                </button>
                        ...
                        <div class="contacts__right">
                            <div class="contacts__text">Если у Вас есть идея, проект, хотите повысить конверсию сайта,
                                оставьте свои данные или посетите один из наших офисов
                            </div>
                            <div class="contacts__info<?= SITE_ID == 's1' || SITE_ID == 's4' ? ' _active' : ''; ?>">
                                <div class="contacts__block">
                                    <div class="contacts__block-item">
                                        ...
                                        <a class="contacts__block-info _large" href="tel:+78007758343">8 (800) 775 83
                                            43</a>
                                    </div>
                                    <div class="contacts__block-item">
                            ...
                            <div class="contacts__info">
                                <div class="contacts__block">
                                    ...
                                    <div class="contacts__block-item">
                                        <div class="contacts__block-name">Адрес</div>
                                        <div class="contacts__block-info">Москва, ул. Угрешская, д.2, стр.31,<br>оф.116
                                        </div>
                                    </div>
                                </div>
                                <div class="contacts__block">
