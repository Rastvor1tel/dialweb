...
<div class="info">
    ...
    <div class="info__wrap-small">
        <form class="feedback-form _consult" action="#" method="post">
            ...
            <label class="feedback-form__label input-label">
                <input class="input-label__input text-input js-phone" type="tel">
                <span class="input-label__placeholder js-placeholder">Ваш телефон</span>
            </label>
            <div class="feedback-form__text">Нажимая ОТПРАВИТЬ я даю согласие на обработку персональных
                данных
            </div>
            <input class="feedback-form__submit button button_white-bg" type="submit" value="Отправить">
        </form>
    </div>
</div>
<div class="tariff">
    <div class="tariff__wrap">
        <div class="tariff__item tariff__item_center">
            <div class="tariff__number"></div>
            <div class="tariff__info">
                <div class="tariff__name">Интернет консалтинг</div>
                <div class="tariff__desc">Стоимость интернет-консалтинга DIAL 5000 руб в час. Мы не
                    работаем с меньшим отрезком времени так как знаем, что 60 минут – минимальное время
                    для хорошего и качественного оказания этой услуги.
                </div>
                <div class="tariff__price">
                    <div class="tariff__price-text">Цена</div>
                    <div class="tariff__price-wrap">
                        <div class="tariff__price-count">5 000</div>
                        <div class="tariff__price-text">рублей</div>
                    </div>
                </div>
                <button class="tariff__order button button_oragne" type="button">Заказать услугу</button>
            </div>
        </div>
    </div>
</div>
