...
<script>
  ...
  fbq('init', '367120160534523');
  fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=367120160534523&ev=PageView&noscript=1"
/></noscript>
...
var onRoistatAllModulesLoaded = function () {
    window.roistat.registerOnVisitProcessedCallback(function () {
        var visit = window.roistat.visit;

        $('[data-roistat-field]').each(function () {
            $(this).val(visit);
        });
    });
}
