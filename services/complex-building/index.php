...
$APPLICATION->SetTitle("Комплексный маркетинг для Строительной сферы деятельности");
...
?>
<div class="top-menu">
    <a href="" class="top-menu__item"></a>
    <a href="" class="top-menu__item"></a>
    <a href="" class="top-menu__item"></a>
</div>
<div class="complex-marketing__text">
    <p>Всегда, наиболее популярной тематикой после интернет-магазинов в интернете было все, что связано со
        строительством.
        Как следствие, привлечь клиентов в строительной отрасли — сложная и дорогостоящая задача. И если раньше
        достаточно
