...
$APPLICATION->SetTitle("Комплексный маркетинг для Мебельной сферы деятельности");
...
<div class="complex-marketing__text">
    <p>Высококонкурентный мебельный бизнес требует особого подхода. И чтобы привлечь максимальное число клиентов о них
        придется хорошо позаботиться: сделать удобный сайт, релевантные посадочные страницы, удобный каталог. Но кроме
        этого, важно снизить стоимость лида. Поэтому в этой сфере не обойтись без комплексного подхода: вначале
        аналитика — затем привлечение трафика. Только такой обдуманный и детальный подход решит поставленные задачи.
    </p>
...
$APPLICATION->IncludeComponent("bitrix:news.list", "cases-slider", array(
    ...
    "SLOGAN" => "НАШИ КЛИЕНТЫ МЕБЕЛЬНОЙ ОТРАСЛИ И ИХ РЕЗУЛЬТАТЫ РАБОТЫ С НАМИ!"
));
